...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/angzla/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |       4m6.161s            |              1m47.55s             | 
| `pg_normalized_batch`  |      3m15.455s            |                     0m30.52s      | 
| `pg_denormalized`      |         0m23.984s         |       0m6.96s                    | 
